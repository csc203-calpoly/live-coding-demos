...
public class Game
{
      ...
      while(!done)
      {
         ...
         else
         {
            ...
            if (done) {
                ...
                if (p1 instanceof GreedyPlayer) // check dynamic type
                    System.out.println(((GreedyPlayer) p1).taunt());
            }
         }
      }
   }
   ...
   public static boolean play(Player p, Pile pile)
   {
      ...
      // ADD taunt stuff here:
      if (p instanceof GreedyPlayer) {
         System.out.print(((GreedyPlayer)p).taunt());
      }
